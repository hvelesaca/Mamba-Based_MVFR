...
if __name__ == "__main__":
    ...
    train_loader = DataLoader(train_dataset, sampler=sampler, batch_size=8, shuffle=False, collate_fn=custom_collate, num_workers=2, pin_memory=True, drop_last=True)
    val_loader = DataLoader(val_dataset, batch_size=8, shuffle=False, collate_fn=custom_collate, num_workers=2, pin_memory=True)
